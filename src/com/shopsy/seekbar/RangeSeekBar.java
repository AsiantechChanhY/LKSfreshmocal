...
public class RangeSeekBar extends View {
    ...
    private void applyConfig(Context context, AttributeSet attrs) {
        ...
        mSeekbarHeight = (int) a.getDimension(
                R.styleable.RangeSeekbar_seekbarHeight, 5);
        mTextSize = (int) a.getDimension(R.styleable.RangeSeekbar_textSize, 3);
        mMarginBetween = (int) a.getDimension(
                R.styleable.RangeSeekbar_spaceBetween, 5);
