...
import com.shopsy.app.Add_Item_Final.RefreshReceiver;
import com.shopsy.loader.ImageLoader;
import com.shopsy.seller.adapter.ImageAdapter_Bitmap_Copy;
import com.shopsy.seller.adapter.ImageAdapter_Copy;
/**
 * @author Prithivi Raj
 *
 */
...
public class Add_Item_Edit_Final_Copy extends HockeyActivity implements OnClickListener, OnShowcaseEventListener
{	
	...
	static ImageAdapter_Copy adapter;
	static ImageAdapter_Bitmap_Copy adapter_bitmap;
	...
	public class RefreshReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction().equals("com.package.UPDATE_EDITPHOTO_FINALPLUS")) {

				IMAGE_GET_COPY_NEW(intent.getByteArrayExtra("byte1"),intent.getByteArrayExtra("byte2"),intent.getByteArrayExtra("byte3"),intent.getByteArrayExtra("byte4"),intent.getByteArrayExtra("byte5"));
			}
		}
	}
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.add_item_edit_final_copy);
		context = Add_Item_Edit_Final_Copy.this;
        ...
        shared_tour = preferences.getString(Iconstant.sharedPre_tour_copy, "");
		Custom_ActionBar();
		...
		// -----code to refresh drawer using broadcast receiver-----
				updatePotoReceiver = new RefreshReceiver();
		     		...
		     		intentFilter.addAction("com.package.UPDATE_EDITPHOTO_FINALPLUS");
		...
		Log.d("shared_tour---->name",""+shared_tour);
		 //       Toast.makeText(context, "Activity", Toast.LENGTH_SHORT).show();
			...
			/*		if (shared_tour.equals("")) {   
						...
						final View selectedView = findViewById(R.id.view_pager_copy);
		...
		viewPager.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View view) {
				Intent int_add_photo = new Intent(Add_Item_Edit_Final_Copy.this,Add_item_photo.class);
				int_add_photo.putExtra("ADD_ITEM_FINAL", "add_item_edit_copy");
	...
	private void Custom_ActionBar() 
	{
        ...
        LayoutInflater mInflater = LayoutInflater.from(Add_Item_Edit_Final_Copy.this);
		...
		textView.setText("Copy Listing");
		imageView.setOnClickListener(new OnClickListener() 
		{	
			@Override
			public void onClick(View v) {
				Add_Item_Edit_Final_Copy.this.finish();
		...
		{	
			...
			public void onClick(View v) {
				...
				if (str_editable.equals("Yes"))
				{
					...
					if (str_title.equals("")) 
					{
						Toast.makeText(Add_Item_Edit_Final_Copy.this,"Add the title to copy", Toast.LENGTH_SHORT).show();
					} else if (str_price.equals("")) 
					{
						Toast.makeText(Add_Item_Edit_Final_Copy.this,"Price is Empty", Toast.LENGTH_SHORT).show();
					} else if (str_qua.equals(""))
					{
						Toast.makeText(Add_Item_Edit_Final_Copy.this,"Quantity is Empty", Toast.LENGTH_SHORT).show();
					} else if (str_des.equals("")) 
					{
						Toast.makeText(Add_Item_Edit_Final_Copy.this,"Description is Empty", Toast.LENGTH_SHORT).show();
					} else if (str_ship.equals("")) 
					{
						Toast.makeText(Add_Item_Edit_Final_Copy.this,"Shipping Address is Empty", Toast.LENGTH_SHORT).show();
					} else 
					{
						if (isConnectingToInternet() == true) {
					...
					Toast.makeText(Add_Item_Edit_Final_Copy.this,"This product is not editable", Toast.LENGTH_SHORT).show();
			}
		});
...
/*		getSupportActionBar().setDisplayHomeAsUpEnabled(true);
		...
		Rl_all = (RelativeLayout) findViewById(R.id.layout_price_add_item_copy_all_final);
		viewPager = (ViewPager) findViewById(R.id.view_pager_copy);
		imageLoader=new ImageLoader(Add_Item_Edit_Final_Copy.this);
...
//		Tv_Shipping.setText(s_tittle+""+ s_time+""+ s_dest+""+ s_from);
		...
		if (bundle ==null) {
			...
			Prod_Id = bundle.getString("INTENT_BUN_COPYITEM"); 
...
//		inflate.inflate(R.menu.add_item_done, menu);
	...
	public void onClick(View v) 
	{
		...
		case R.id.layoutproduct:
			...
			Remove_session();
			Intent int_additem = new Intent(Add_Item_Edit_Final_Copy.this, Add_Item_1_Copy.class);
		...
		case R.id.imageview_camera_additem_final_additem_final:
			...
			Intent int_add_photo1 = new Intent(Add_Item_Edit_Final_Copy.this,Add_item_photo.class);
			int_add_photo1.putExtra("ADD_ITEM_FINAL", "add_item_edit_copy");
		...
		case R.id.layout_shipping_additem_final:
			...
			Log.d("Additem_edit_copy_address--------------", str_add_addrsss);
			...
			Log.e("count-copy--------------",""+ count);
			if (count==1) {
				editor.putString(Iconstant.Session_Type, "add_item_ship_edit_copy");
			...
			}else
			{
				...
				editor.commit();
				 ...
				 Log.d("Session_Type_cost---------------->:",""+s_cost+", ");
			     Log.d("Session_Type_ano_cost---------------->:",""+s_ano_cost+", ");
			     Log.d("Session_Type_country---------------->:",""+s_dest+", ");
				Log.d("Session_Type_country_Id---------------->:",""+s_des_id+", ");
			}
			
			Intent int_shipping = new Intent(Add_Item_Edit_Final_Copy.this,Add_Item_shipping_Profile.class);
...
//			Add_Item_Edit_Final.this.finish();
		...
		case R.id.textView_shipping_child:
			...
			Intent int_shipping1 = new Intent(Add_Item_Edit_Final_Copy.this,Add_Item_shipping_Profile.class);
...
//			Toast.makeText(Add_Item_Edit_Final.this, "Coming Soon",Toast.LENGTH_SHORT).show();
	...
	private void custom_dialog_item_tittle() {
		// custom dialog
		final Dialog dialog = new Dialog(Add_Item_Edit_Final_Copy.this);
...
/*				TextView tv1 = new TextView(Add_Item_Edit_Final.this);
				...
				rl.addView(tv1);*/
				Add_tag = Editext_PopUp.getText().toString();
				final Button button1 = new Button(Add_Item_Edit_Final_Copy.this);
				LinearLayout layout = new LinearLayout(Add_Item_Edit_Final_Copy.this);
...
//					params1.setMargins(left, top, right, bottom);
	...
	class Async_Task_Profile extends AsyncTask<Object, Void, Boolean>
	{
		...
		String Url = Iconstant.profile_url;

		@Override
		protected void onPreExecute() 
		{
			Log.e("Url_Copy--------->", "" + Url);
			progress = ProgressDialog.show(Add_Item_Edit_Final_Copy.this, null,"Adding Product !!!");
			if (!p_image1.equals("")) {
		...
		protected void onPostExecute(Boolean result) 
		{
			...
			{				
				if (Response_Message.equals(Iconstant.AddItemFinal_Response)) 
				{
					...
					progress.dismiss();
					Toast.makeText(Add_Item_Edit_Final_Copy.this, "Item Copied Successfully", Toast.LENGTH_SHORT).show();
					Add_Item_Edit_Final_Copy.this.finish();
					overridePendingTransition(R.anim.left_right, R.anim.right_left);
					
				} else 
				{
//					Toast.makeText(Add_Item_Edit_Final_Copy.this, s, Toast.LENGTH_SHORT).show();
					progress.dismiss();
	...
	class Async_Dispute_Edit_Pro extends AsyncTask<Void, Void, Boolean>
	{
		...
		{
			array_image.clear();
			Url = Iconstant.copy_item+Prod_Id+Iconstant.edit_seller_Id+seller_id;  
			Log.e("Url_Edit--------->", "" + Url);
			progress = ProgressDialog.show(Add_Item_Edit_Final_Copy.this, null, "Checking for update !!!");
...
//							p_pro_title = object.getString("title");
							...
							str_editable = object.getString("copyable");
...
/*									p_shipping_country+= object_data.getString("country")+",";
		...
		protected void onPostExecute(Boolean result) 
		{
			if (result==true) 
			{
				if (status_empty) 
				{
					Log.e("imagePath-------->","" + Iconstant.imageurl+p_image1.toString());
...
*/				
					...
					progress.dismiss();
					adapter = new ImageAdapter_Copy(Add_Item_Edit_Final_Copy.this, array_image);
...
//				LoadingImage.setVisibility(View.GONE);
	...
	{
		new AlertDialog.Builder(Add_Item_Edit_Final_Copy.this)
	...
	//    	  Toast.makeText(getApplicationContext(), "Home_Pressed", Toast.LENGTH_SHORT).show();
	 ...
	 static class ADD_IMAGE_COPY
	 {
		 static void IMAGE_GET_COPY(byte[] image_Pick_1, byte[] image_Pick_2, byte[] image_Pick_3, byte[] image_Pick_4, byte[] image_Pick_5)
		 {
			 	byteArray1=null;
				byteArray2=null;
				byteArray3=null; 
			 ...
			 if (image_Pick_1 !=null) 
				...
				array_image.clear();
				adapter.notifyDataSetChanged();
				adapter_bitmap = new ImageAdapter_Bitmap_Copy(context, array_bitmap); 
	 ...
	 private void IMAGE_GET_COPY_NEW(byte[] image_Pick_1, byte[] image_Pick_2, byte[] image_Pick_3, byte[] image_Pick_4, byte[] image_Pick_5)
	 {
		 	byteArray1=null;
			byteArray2=null;
			byteArray3=null; 
	 ...
	 static class ADD_ADDRESS_COPY
	 {
		 static void ADDRESS_COPY(String s_tittle1, String s_time1, String s_dest1, String s_from1, String s_cost1, String s_ano_cost1, String s_dest_id1)
		 {
		        s_tittle = s_tittle1;
		        s_time = s_time1;
		        s_dest = s_dest1;
		        ...
		        Log.d("title_add_item_copy", s_tittle);
		        Log.d("s_time_add_item_copy", s_time);
		        Log.d("s_dest_add_item_copy", s_dest);
		        Log.d("s_from_add_item_copy", s_from);
		        Log.d("s_cost_add_item_copy", s_cost);
		        Log.d("s_ano_cost_add_item_copy", s_ano_cost);
		        Log.d("s_des_id_add_item_copy", s_des_id);
		 }
	 }
...
//	        btn_add.setTitle("button_hide");
	    ...
	    public static class Tour_Copy
	    {
	    	public static void Tour_ssession_copy()
	    	{
				editor.putString(Iconstant.sharedPre_tour_copy, "tittle_copy");
				editor.commit();
...
//	                    sv.setStyle(R.style.CustomShowcaseTheme);
	    ...
	    public static class GET_Shared_Copy
	    {
	    	public static void GET_SH_Copy()
	    	{
	    		...
	    		Log.d("get_shared_Categories Id-===copy====-->", "" + cat_1+","+cat_2+","+cat_3);
	    		Log.e("get_shared_Add Id--=====--copy----=======--->", "" + about_1+","+about_2+","+about_3);
	    		Log.d("get_shared_Categories Name-====copy====-->", "" + Name_1+","+Name_2+","+Name_3);
	    	}
	    }
