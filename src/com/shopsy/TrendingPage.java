 ...
 *
 */
public class TrendingPage extends Fragment_subclass 
{
	...
	{
		return inflater.inflate(R.layout.trendingpage, container, false);
	}
	...
	private void initialize() 
	{
		...
		gridview=(StaggeredGridView)getView().findViewById(R.id.trending_GridView);
		loading=(RelativeLayout)getView().findViewById(R.id.trending_loading_layout);
		nointernet=(RelativeLayout)getView().findViewById(R.id.trending_nointernet_layout);
		mainlayout=(RelativeLayout)getView().findViewById(R.id.trending_main_layout);
		
		trending_loading=(ImageView)getView().findViewById(R.id.trending_loading_gif);
		
		swipeRefreshLayout = (SwipeRefreshLayout)getView().findViewById(R.id.trending_swipe_refresh_layout);
