...
import com.shopsy.adapter.Order_ViewPagerAdapter;

public class OrdersPage extends HockeyActivity
{
	private ViewPager pager;
	private Order_ViewPagerAdapter adapter;
    SlidingTabLayout tabs;
    private CharSequence Titles[]={"OPEN","COMPLETED"};
	...
	{
		 adapter =  new Order_ViewPagerAdapter(getSupportFragmentManager(),Titles,Numboftabs);
	...
	private void setupToolbar()
	{
	   ...
	   // code to disable actionBar title
		...
		View view = OrdersPage.this.getLayoutInflater().inflate(R.layout.openshop_header, null);
		actionBar.setCustomView(view);
		
		header_title=(TextView)view.findViewById(R.id.openshop_header_title);
		header_title.setText(getResources().getString(R.string.order_label_order));
    }
