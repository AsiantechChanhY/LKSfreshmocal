...
public class ActionBarActivity_Subclass_CartPage extends HockeyActivity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	// Buttons
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
	     ...
	     // Session class instance
			session_manager = new SessionManager(ActionBarActivity_Subclass_CartPage.this);
			commonsession = new CommonIDSessionManager(ActionBarActivity_Subclass_CartPage.this);
	...
	{
		favorite_dialog = new Dialog(ActionBarActivity_Subclass_CartPage.this);
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(ActionBarActivity_Subclass_CartPage.this, new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(ActionBarActivity_Subclass_CartPage.this, FacebookLoginPage.class);
	...
	{
		forgot_dialog = new Dialog(ActionBarActivity_Subclass_CartPage.this);
		...
		//code to make password editText as dot
		 ...
		 for_submit.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v)
			{
				...
				{
					ConnectionDetector cd = new ConnectionDetector(ActionBarActivity_Subclass_CartPage.this);
					...
					{
						Toast.makeText(ActionBarActivity_Subclass_CartPage.this, "No Internet Connection", Toast.LENGTH_SHORT).show();						
					}
				}
	...
	{
		signin_dialog = new Dialog(ActionBarActivity_Subclass_CartPage.this);
	...
	{
		register_dialog = new Dialog(ActionBarActivity_Subclass_CartPage.this);
		...
		//code to make password editText as dot
		 ...
		 reg_terms.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v) 
			{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
				if (isInternetPresent) {
					Intent intent = new Intent(ActionBarActivity_Subclass_CartPage.this,
							WebviewPage.class);
					...
					Toast.makeText(ActionBarActivity_Subclass_CartPage.this,
	...
	//--------------------Code to set error for EditText-----------------------
			...
			{
				Animation shake = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_CartPage.this, R.anim.shake);
		    	 ...
		    	 if (requestCode == FaebookCode && resultCode == Activity.RESULT_OK && data != null) {
		             String MySelectedClass = data.getStringExtra("SelectedClass");
		              ...
		              //code to refresh drawer list
						...
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_CartPage.this, CartPage.class);
						startActivity(intent);
						overridePendingTransition(R.anim.enter, R.anim.exit);
		    	 }
	...
	//------------------------------code for Login AsynTask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_CartPage.this, "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_CartPage.this, R.anim.shake);
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					if(load_class.equalsIgnoreCase("cart_page"))
					{
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_CartPage.this, CartPage.class);
						startActivity(intent);
				...
				{
					Toast.makeText(ActionBarActivity_Subclass_CartPage.this, "Server Problem", Toast.LENGTH_SHORT).show();
				}
		...
		class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_CartPage.this, "", "Please Wait ...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
			...
			protected void onPostExecute(Boolean result)
			{
			     ...
			     progressDialog.dismiss();
					...
					if (response_status.equalsIgnoreCase("0")) 
					{
						final MaterialDialog alertDialog= new MaterialDialog(ActionBarActivity_Subclass_CartPage.this);
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_CartPage.this, "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
		...
		//------------------------------code for GooglePlus asynTask----------------------------------
				class GooglePlusLogin_AsyncTask extends AsyncTask<String, Void, Boolean> 
				{
					...
					{
						super.onPreExecute();
						  progress = new ProgressDialog(ActionBarActivity_Subclass_CartPage.this);
					...
					protected void onPostExecute(Boolean result) 
					{
						...
						else if (response_status.equalsIgnoreCase("1")) 
						{
							...
							//code to refresh drawer list
								...
								if(SselectedClass.equalsIgnoreCase("cart_page"))
								{
									finish();
									Intent intent = new Intent(ActionBarActivity_Subclass_CartPage.this, CartPage.class);
									startActivity(intent);
