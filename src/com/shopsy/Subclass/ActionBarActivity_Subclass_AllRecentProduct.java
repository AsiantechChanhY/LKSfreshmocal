...
import com.shopsy.AllRecentProducts;
...
public class ActionBarActivity_Subclass_AllRecentProduct extends HockeyActivity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	// Buttons
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
	     ...
	     // Session class instance
			session_manager = new SessionManager(ActionBarActivity_Subclass_AllRecentProduct.this);
			commonsession = new CommonIDSessionManager(ActionBarActivity_Subclass_AllRecentProduct.this);
	...
	{
		favorite_dialog = new Dialog(ActionBarActivity_Subclass_AllRecentProduct.this);
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(ActionBarActivity_Subclass_AllRecentProduct.this, new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(ActionBarActivity_Subclass_AllRecentProduct.this, FacebookLoginPage.class);
	...
	{
		signin_dialog = new Dialog(ActionBarActivity_Subclass_AllRecentProduct.this);
		...
		sign_login.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				{
					ConnectionDetector cd = new ConnectionDetector(ActionBarActivity_Subclass_AllRecentProduct.this);
					...
					{
						Toast.makeText(ActionBarActivity_Subclass_AllRecentProduct.this, "No Internet Connection", Toast.LENGTH_SHORT).show();						
					}
				}
			}
		});
	...
	{
		register_dialog = new Dialog(ActionBarActivity_Subclass_AllRecentProduct.this);
		...
		//code to make password editText as dot
		 ...
		 reg_terms.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v) 
			{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
				if (isInternetPresent) {
					Intent intent = new Intent(ActionBarActivity_Subclass_AllRecentProduct.this,
							WebviewPage.class);
					...
					Toast.makeText(ActionBarActivity_Subclass_AllRecentProduct.this,
	...
	{
		forgot_dialog = new Dialog(ActionBarActivity_Subclass_AllRecentProduct.this);
	...
	//--------------------Code to set error for EditText-----------------------
			...
			{
				Animation shake = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_AllRecentProduct.this, R.anim.shake);
		    	 ...
		    	 if (requestCode == FaebookCode && resultCode == Activity.RESULT_OK && data != null) {
		             ...
		             favorite_dialog.dismiss();
		              ...
		              //code to refresh drawer list
						...
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_AllRecentProduct.this, AllRecentProducts.class);
						startActivity(intent);
						overridePendingTransition(R.anim.enter, R.anim.exit);	
		    	 }
	...
	//------------------------------code for Login asyntask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_AllRecentProduct.this, "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_AllRecentProduct.this, R.anim.shake);
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					if(load_class.equalsIgnoreCase("allrecentproducts"))
					{
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_AllRecentProduct.this, AllRecentProducts.class);
						startActivity(intent);
				...
				{
					Toast.makeText(ActionBarActivity_Subclass_AllRecentProduct.this, "Server Problem", Toast.LENGTH_SHORT).show();
				}
		...
		//------------------------------code for forgotPAssword asyntask----------------------------------
				class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
					...
					protected void onPreExecute() {
						...
						progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_AllRecentProduct.this, "", "Please Wait ...", false);
					}
					@Override
					protected Boolean doInBackground(String... urls) 
					{
						...
						try {
							...
							nameValuePairs.add(new BasicNameValuePair("email",for_email.getText().toString()));
							httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
							HttpResponse response = httpclient.execute(httppost);
							HttpEntity entity = response.getEntity();
							Response = EntityUtils.toString(entity);
					...
					protected void onPostExecute(Boolean result)
					{
						...
						if (response_status.equalsIgnoreCase("0")) 
						{
							final MaterialDialog alertDialog= new MaterialDialog(ActionBarActivity_Subclass_AllRecentProduct.this);
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_AllRecentProduct.this, "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
		...
		class GooglePlusLogin_AsyncTask extends AsyncTask<String, Void, Boolean> 
		{
			...
			{
				super.onPreExecute();
				  progress = new ProgressDialog(ActionBarActivity_Subclass_AllRecentProduct.this);
			...
			protected void onPostExecute(Boolean result) 
			{
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					//code to refresh drawer list
						...
						if(SselectedClass.equalsIgnoreCase("allrecentproducts"))
						{
							finish();
							Intent intent = new Intent(ActionBarActivity_Subclass_AllRecentProduct.this, AllRecentProducts.class);
							startActivity(intent);
