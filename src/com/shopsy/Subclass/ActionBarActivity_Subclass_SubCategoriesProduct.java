 ...
 *
 */
public class ActionBarActivity_Subclass_SubCategoriesProduct extends HockeyActivity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	int intent1=0;
	String intent2="";
	ArrayList<String> intent3,intent4;
	...
	// Buttons
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
	     ...
	     // Session class instance
			session_manager = new SessionManager(ActionBarActivity_Subclass_SubCategoriesProduct.this);
			commonsession = new CommonIDSessionManager(ActionBarActivity_Subclass_SubCategoriesProduct.this);
	...
	public void favourit_popup(final String classname,int i1,String i2,ArrayList<String> i3,ArrayList<String> i4)
	{
		favorite_dialog = new Dialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(ActionBarActivity_Subclass_SubCategoriesProduct.this, new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(ActionBarActivity_Subclass_SubCategoriesProduct.this, FacebookLoginPage.class);
                        intent.putExtra("GCM_Id", GCM_Id);
                        intent.putExtra("SelectedClass", classname);
                        intent.putExtra("catposition", intent1);
						intent.putStringArrayListExtra("spinnerlist", intent3);
						intent.putExtra("itemid", intent2);
						intent.putStringArrayListExtra("totalitemid", intent4);
	...
	{
		forgot_dialog = new Dialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
		...
		//code to make password editText as dot
		 ...
		 for_submit.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v)
			{
				...
				{
					ConnectionDetector cd = new ConnectionDetector(ActionBarActivity_Subclass_SubCategoriesProduct.this);
					...
					{
						Toast.makeText(ActionBarActivity_Subclass_SubCategoriesProduct.this, "No Internet Connection", Toast.LENGTH_SHORT).show();						
					}
				}
	...
	{
		signin_dialog = new Dialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
	...
	{
		register_dialog = new Dialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
		...
		//code to make password editText as dot
		 ...
		 reg_terms.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v) 
			{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
				if (isInternetPresent) {
					Intent intent = new Intent(ActionBarActivity_Subclass_SubCategoriesProduct.this,
							WebviewPage.class);
					...
					Toast.makeText(ActionBarActivity_Subclass_SubCategoriesProduct.this,
	...
	//--------------------Code to set error for EditText-----------------------
			...
			{
				Animation shake = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_SubCategoriesProduct.this, R.anim.shake);
	...
	//-----------------------Code for Loading Animation----------------------------------
	    ...
	    //--------------------------GooglePlus Functionality [STOPS]---------------------------
		 ...
		 @Override
			protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		    	 ...
		    	 if (requestCode == FaebookCode && resultCode == Activity.RESULT_OK && data != null) {
		             ...
		             int Sintent1 = data.getIntExtra("catposition", 0);
		             ArrayList<String> Sintent3 = data.getStringArrayListExtra("spinnerlist");
		             String Sintent2 = data.getStringExtra("itemid");
		             ArrayList<String> Sintent4 = data.getStringArrayListExtra("totalitemid");
		              ...
		              //code to refresh drawer list
						...
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_SubCategoriesProduct.this, SubCategories_Product.class);
						intent.putExtra("catposition", Sintent1);
						intent.putStringArrayListExtra("spinnerlist", Sintent3);
						intent.putExtra("itemid", Sintent2);
						intent.putStringArrayListExtra("totalitemid", Sintent4);
						startActivity(intent);
						overridePendingTransition(R.anim.enter, R.anim.exit);
		    	 }
	...
	//------------------------------code for Login asyntask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SubCategoriesProduct.this, "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				Log.e("output signin----------------->", String.valueOf(Response));
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_SubCategoriesProduct.this, R.anim.shake);
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					if(load_class.equalsIgnoreCase("subcategories_product"))
					{
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_SubCategoriesProduct.this, SubCategories_Product.class);
						intent.putExtra("catposition", intent1);
				...
				{
					Toast.makeText(ActionBarActivity_Subclass_SubCategoriesProduct.this, "Server Problem", Toast.LENGTH_SHORT).show();
				}
		...
		class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SubCategoriesProduct.this, "", "Please Wait ...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
			...
			protected void onPostExecute(Boolean result)
			{
			     ...
			     progressDialog.dismiss();
					...
					if (response_status.equalsIgnoreCase("0")) 
					{
						final MaterialDialog alertDialog= new MaterialDialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SubCategoriesProduct.this, "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
			...
			protected void onPostExecute(Boolean result)
			{
				...
				Log.e("output register----------------->", String.valueOf(Response));
				Log.e("output register msg----------------->", msg);
		...
		class GooglePlusLogin_AsyncTask extends AsyncTask<String, Void, Boolean> 
		{
			...
			{
				super.onPreExecute();
				  progress = new ProgressDialog(ActionBarActivity_Subclass_SubCategoriesProduct.this);
			...
			protected void onPostExecute(Boolean result) 
			{
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					//code to refresh drawer list
						...
						if(SselectedClass.equalsIgnoreCase("subcategories_product"))
						{
							finish();
							Intent intent = new Intent(ActionBarActivity_Subclass_SubCategoriesProduct.this, SubCategories_Product.class);
							intent.putExtra("catposition", intent1);
