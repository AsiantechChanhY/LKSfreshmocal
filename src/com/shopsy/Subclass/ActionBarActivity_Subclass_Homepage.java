...
import com.shopsy.AllShopPage;
import com.shopsy.CategoryPage;
import com.shopsy.FacebookLoginPage;
import com.shopsy.HomePage;
import com.shopsy.OpenShopPage;
import com.shopsy.R;
import com.shopsy.TrendingPage;
import com.shopsy.UserProfile;
...
public class ActionBarActivity_Subclass_Homepage extends HockeyActivity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	public void favourit_popup(final String classname)
	{
		favorite_dialog = new Dialog(ActionBarActivity_Subclass_Homepage.this);
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(ActionBarActivity_Subclass_Homepage.this, new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(ActionBarActivity_Subclass_Homepage.this, FacebookLoginPage.class);
                        intent.putExtra("GCM_Id", GCM_Id);
                        intent.putExtra("SelectedClass", SselectedClass);
	...
	{
		forgot_dialog = new Dialog(ActionBarActivity_Subclass_Homepage.this);
		...
		//code to make password editText as dot
		 ...
		 for_submit.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v)
			{
				...
				{
					ConnectionDetector cd = new ConnectionDetector(ActionBarActivity_Subclass_Homepage.this);
					...
					{
						Toast.makeText(ActionBarActivity_Subclass_Homepage.this, "No Internet Connection", Toast.LENGTH_SHORT).show();						
					}
				}
	...
	{
		signin_dialog = new Dialog(ActionBarActivity_Subclass_Homepage.this);
	...
	{
		register_dialog = new Dialog(ActionBarActivity_Subclass_Homepage.this);
		...
		//code to make password editText as dot
		 ...
		 reg_terms.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v) 
			{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
				if (isInternetPresent) {
					Intent intent = new Intent(ActionBarActivity_Subclass_Homepage.this,
							WebviewPage.class);
					...
					Toast.makeText(ActionBarActivity_Subclass_Homepage.this,
	...
	//--------------------Code to set error for EditText-----------------------
			...
			{
				Animation shake = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_Homepage.this, R.anim.shake);
	    	 ...
	    	 if (requestCode == FaebookCode && resultCode == Activity.RESULT_OK && data != null) {
	             ...
	             favorite_dialog.dismiss();
	              ...
	              //code to refresh drawer list
					...
					broadcastIntent1.setAction("com.package.UPDATECLASS");
					broadcastIntent1.putExtra("SelectedClass", MySelectedClass);
	...
	//------------------------------code for Login asyntask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_Homepage.this, "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_Homepage.this, R.anim.shake);
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					if(load_class.equalsIgnoreCase("trending"))
					{
					...
					else if(load_class.equalsIgnoreCase("feed"))
					{
					...
					else if(load_class.equalsIgnoreCase("allshop"))
					{
					...
					else if(load_class.equalsIgnoreCase("categories"))
					{
					...
					else if(load_class.equalsIgnoreCase("openshop"))
					{
						Intent intent=new Intent(ActionBarActivity_Subclass_Homepage.this,OpenShopPage.class);
			        	startActivity(intent);
			        	overridePendingTransition(R.anim.enter, R.anim.exit);
					}
					else if(load_class.equalsIgnoreCase("userprofile"))
					{
					...
					else if(load_class.equalsIgnoreCase("home"))
					{
				...
				{
					Toast.makeText(ActionBarActivity_Subclass_Homepage.this, "Server Problem", Toast.LENGTH_SHORT).show();
				}
		...
		class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_Homepage.this, "", "Please Wait ...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
			...
			protected void onPostExecute(Boolean result)
			{
			     ...
			     progressDialog.dismiss();
					...
					if (response_status.equalsIgnoreCase("0")) 
					{
						final MaterialDialog alertDialog= new MaterialDialog(ActionBarActivity_Subclass_Homepage.this);
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_Homepage.this, "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
		...
		//------------------------------code for GooglePlus asynTask----------------------------------
				class GooglePlusLogin_AsyncTask extends AsyncTask<String, Void, Boolean> 
				{
					...
					{
						super.onPreExecute();
						  progress = new ProgressDialog(ActionBarActivity_Subclass_Homepage.this);
					...
					protected void onPostExecute(Boolean result) 
					{
						...
						else if (response_status.equalsIgnoreCase("1")) 
						{
							...
							if(SselectedClass.equalsIgnoreCase("trending"))
							{
								Fragment fragment = new TrendingPage();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
							...
							else if(SselectedClass.equalsIgnoreCase("feed"))
							{
								Fragment fragment = new ActivityFeed();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
							...
							else if(SselectedClass.equalsIgnoreCase("allshop"))
							{
								Fragment fragment = new AllShopPage();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
							...
							else if(SselectedClass.equalsIgnoreCase("categories"))
							{
								Fragment fragment = new CategoryPage();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
							...
							else if(SselectedClass.equalsIgnoreCase("openshop"))
							{
								Intent intent=new Intent(ActionBarActivity_Subclass_Homepage.this,OpenShopPage.class);
					        	startActivity(intent);
					        	overridePendingTransition(R.anim.enter, R.anim.exit);
							}
							else if(SselectedClass.equalsIgnoreCase("userprofile"))
							{
								Fragment fragment = new UserProfile();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
							...
							else if(SselectedClass.equalsIgnoreCase("home"))
							{
								Fragment fragment = new HomePage();
								FragmentManager fragmentManager = getSupportFragmentManager();
								FragmentTransaction ft = fragmentManager.beginTransaction();
