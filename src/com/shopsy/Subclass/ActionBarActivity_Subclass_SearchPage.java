...
public class ActionBarActivity_Subclass_SearchPage extends HockeyActivity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	// Buttons
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
	     ...
	     // Session class instance
			session_manager = new SessionManager(ActionBarActivity_Subclass_SearchPage.this);
			commonsession = new CommonIDSessionManager(ActionBarActivity_Subclass_SearchPage.this);
	...
	public void favourit_popup(final String classname,String searchdata)
	{
		favorite_dialog = new Dialog(ActionBarActivity_Subclass_SearchPage.this);
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(ActionBarActivity_Subclass_SearchPage.this, new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(ActionBarActivity_Subclass_SearchPage.this, FacebookLoginPage.class);
                        intent.putExtra("GCM_Id", GCM_Id);
                        intent.putExtra("SelectedClass", classname);
                        intent.putExtra("ExtradataID", search_intent);
	...
	{
		forgot_dialog = new Dialog(ActionBarActivity_Subclass_SearchPage.this);
		...
		//code to make password editText as dot
		 ...
		 for_submit.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v)
			{
				...
				{
					ConnectionDetector cd = new ConnectionDetector(ActionBarActivity_Subclass_SearchPage.this);
					...
					{
						Toast.makeText(ActionBarActivity_Subclass_SearchPage.this, "No Internet Connection", Toast.LENGTH_SHORT).show();						
					}
				}
	...
	{
		signin_dialog = new Dialog(ActionBarActivity_Subclass_SearchPage.this);
	...
	{
		register_dialog = new Dialog(ActionBarActivity_Subclass_SearchPage.this);
		...
		//code to make password editText as dot
		 ...
		 reg_terms.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View v) 
			{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
				if (isInternetPresent) {
					Intent intent = new Intent(ActionBarActivity_Subclass_SearchPage.this,
							WebviewPage.class);
					...
					Toast.makeText(ActionBarActivity_Subclass_SearchPage.this,
	...
	//--------------------Code to set error for EditText-----------------------
			...
			{
				Animation shake = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_SearchPage.this, R.anim.shake);
		 ...
		 @Override
			protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		    	 ...
		    	 if (requestCode == FaebookCode && resultCode == Activity.RESULT_OK && data != null) {
		             ...
		             String SsearchIntent = data.getStringExtra("ExtradataID");
		             ...
		             favorite_dialog.dismiss();
		              ...
		              //code to refresh drawer list
						...
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_SearchPage.this, SearchPage.class);
						intent.putExtra("search_data", SsearchIntent);
						startActivity(intent);
						overridePendingTransition(R.anim.enter, R.anim.exit);
		    	 }
	...
	//------------------------------code for Login AsynTask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SearchPage.this, "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(ActionBarActivity_Subclass_SearchPage.this, R.anim.shake);
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					if(load_class.equalsIgnoreCase("search_page"))
					{
						finish();
						Intent intent = new Intent(ActionBarActivity_Subclass_SearchPage.this, SearchPage.class);
						intent.putExtra("search_data", search_intent);
						startActivity(intent);
						overridePendingTransition(R.anim.enter, R.anim.exit);
					}
				}
				...
				{
					Toast.makeText(ActionBarActivity_Subclass_SearchPage.this, "Server Problem", Toast.LENGTH_SHORT).show();
				}
		...
		class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SearchPage.this, "", "Please Wait ...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
			...
			protected void onPostExecute(Boolean result)
			{
			     progressDialog.dismiss();
					...
					if (response_status.equalsIgnoreCase("0")) 
					{
						final MaterialDialog alertDialog= new MaterialDialog(ActionBarActivity_Subclass_SearchPage.this);
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(ActionBarActivity_Subclass_SearchPage.this, "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
		...
		class GooglePlusLogin_AsyncTask extends AsyncTask<String, Void, Boolean> 
		{
			...
			{
				super.onPreExecute();
				  progress = new ProgressDialog(ActionBarActivity_Subclass_SearchPage.this);
			...
			protected void onPostExecute(Boolean result) 
			{
				...
				else if (response_status.equalsIgnoreCase("1")) 
				{
					...
					//code to refresh drawer list
						...
						if(SselectedClass.equalsIgnoreCase("search_page"))
						{
							finish();
							Intent intent = new Intent(ActionBarActivity_Subclass_SearchPage.this, SearchPage.class);
							intent.putExtra("search_data", search_intent);
