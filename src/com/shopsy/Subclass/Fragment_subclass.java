 ...
 *
 */
public class Fragment_subclass extends HockeyFragment implements ConnectionCallbacks, OnConnectionFailedListener
{
		...
		public void onCreate(Bundle savedInstanceState) 
		{
	     ...
	     // -----code to refresh drawer using broadcast receiver-----
	        googleSignoutReceiver = new RefreshReceiver();
	     		...
	     		getActivity().registerReceiver(googleSignoutReceiver, intentFilter);
	...
	{
		favorite_dialog = new Dialog(getActivity());
		...
		FbLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//---------Getting GCM Id----------
                GCMIntializer initializer = new GCMIntializer(getActivity(), new GCMIntializer.CallBack()
                {
                    @Override
                    public void onRegisterComplete(String registerationId) {
                        ...
                        Intent intent = new Intent(getActivity(), FacebookLoginPage.class);
		...
		googleplus.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				...
				System.out.println("------------------fragment onclcik--------------");
	...
	{
		forgot_dialog = new Dialog(getActivity());
	...
	{
		signin_dialog = new Dialog(getActivity());
	...
	{
		register_dialog = new Dialog(getActivity());
	...
	//-------------------------code to Check Email Validation-----------------------
	    ...
	    public void onConnected(Bundle arg0) {
	        ...
	        else
	        {
	        	...
	        	GooglePlusLogin_AsyncTask1 googleplus_asyntask = new GooglePlusLogin_AsyncTask1();
		...
		public void onDestroy() {
			...
			getActivity().unregisterReceiver(googleSignoutReceiver);
			super.onDestroy();
		}
	...
	//------------------------------code for Login asyntask----------------------------------
		class LoginAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() {
				...
				progressDialog = ProgressDialog.show(getActivity(), "", "Logging in...", false);
			}
			@Override
			...
			protected void onPostExecute(Boolean result)
			{
				...
				if (response_status.equalsIgnoreCase("0")) 
				{
					...
					Animation shakepwd = AnimationUtils.loadAnimation(getActivity(), R.anim.shake);
		...
		class ForgotPasswordAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected Boolean doInBackground(String... urls) 
			{
				...
				try {
					...
					{
						 System.out.println("message"+Response+"aadsad"+status);
					}
		...
		class RegisterAsyncTask extends AsyncTask<String, Void, Boolean> {
			...
			protected void onPreExecute() 
			{
				...
				progressDialog = ProgressDialog.show(getActivity(), "", "Signing up...", false);
			}
			@Override
			protected Boolean doInBackground(String... urls) 
			{
		...
		class GooglePlusLogin_AsyncTask1 extends AsyncTask<String, Void, Boolean> 
		{
