...
public class OrderCompleted_Adapter extends BaseAdapter 
{

	private ArrayList<OrderCompleted_Pojo> data;
	ImageLoader_BandWidth imageLoader_bandwidth;
	private LayoutInflater mInflater;
	private Context context;

	public OrderCompleted_Adapter(Context c,ArrayList<OrderCompleted_Pojo> d)
	{
		context=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if(convertView == null) 
		{
			view = mInflater.inflate(R.layout.order_completedtab_single, parent, false);
			holder = new ViewHolder();
			holder.date = (TextView) view.findViewById(R.id.order_completed_single_date);
			holder.productname = (TextView) view.findViewById(R.id.order_completed_single_productname);
			holder.quantity = (TextView) view.findViewById(R.id.order_completed_single_quantity);
			holder.orderid = (TextView) view.findViewById(R.id.order_completed_single_orderid);
			holder.price = (TextView) view.findViewById(R.id.order_completed_single_ordertotal_price);
			holder.status = (TextView) view.findViewById(R.id.order_completed_single_status_textview);
			holder.product_image = (ImageView) view.findViewById(R.id.order_completed_single_productimage);
