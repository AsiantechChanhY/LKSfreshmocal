...
public class PurchaseAdapter extends BaseAdapter 
{
	...
	private ArrayList<PurchasePojo> data;
	 ImageLoader_BandWidth imageLoader_bandwidth;
	private LayoutInflater mInflater;
	private Context context;

	public PurchaseAdapter(Context c,ArrayList<PurchasePojo> d)
	{
		context=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		Picasso.with(context).load(String.valueOf(data.get(position).getProductImage())).placeholder(R.drawable.no_image_grey).into(holder.product_image);
