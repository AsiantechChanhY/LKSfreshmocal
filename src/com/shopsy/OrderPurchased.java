...
public class OrderPurchased extends HockeyFragment
{
								...
								if(show_progress_status)
								{
									...
									boolean isInternetPresent = cd.isConnectingToInternet();
										...
										if (isInternetPresent) 
										{
											...
											{
												Loadmore_JsonRequest(Iconstant.order_purchase_url + userid+"&commonId="+userid+"&pageId="+checkpagepos);
											}
										} 
										else 
										{
				...
				boolean isInternetPresent = cd.isConnectingToInternet();
						...
						if (isInternetPresent) 
						{
							if(session.isLoggedIn())
							{
								...
								JsonRequest(Iconstant.order_purchase_url + userid+"&commonId="+userid+"&pageId=1");
							}
						} 
						else
						{
