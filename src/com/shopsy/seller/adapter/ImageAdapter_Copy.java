...
import com.shopsy.R;
import com.shopsy.app.Add_Item_Edit_Final_Copy.Tour_Copy;
...
public class ImageAdapter_Copy extends PagerAdapter
{
	Context ctx;
	Activity Activity;
	...
	public ImageAdapter_Copy(Context context, ArrayList<String> images) {
		this.ctx = context;
...
//		imageView.setPadding(padding, padding, padding, padding);
		...
		imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent int_add_photo = new Intent(ctx,Add_item_photo.class);
				int_add_photo.putExtra("ADD_ITEM_FINAL", "add_item_edit_copy");
				ctx.startActivity(int_add_photo);
