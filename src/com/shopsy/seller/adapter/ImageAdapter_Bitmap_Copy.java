...
public class ImageAdapter_Bitmap_Copy extends PagerAdapter
{
	Context ctx;
	Activity Activity;
	private ArrayList<Bitmap> GalImages;
	public ImageLoader imageLoader;
	
	public ImageAdapter_Bitmap_Copy(Context context, ArrayList<Bitmap> array_bitmap) {
		this.ctx = context;
		this.GalImages = array_bitmap;
