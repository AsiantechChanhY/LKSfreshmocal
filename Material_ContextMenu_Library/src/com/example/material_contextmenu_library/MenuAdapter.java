 ...
 */
    ...
    private void buildChosenAnimation(int childIndex) {
        List<Animator> fadeOutTextTopAnimatorList = new ArrayList<Animator>();
        List<Animator> closeToBottomImageAnimatorList = new ArrayList<Animator>();
        ...
        List<Animator> fadeOutTextBottomAnimatorList = new ArrayList<Animator>();
        List<Animator> closeToTopAnimatorObjects = new ArrayList<Animator>();
